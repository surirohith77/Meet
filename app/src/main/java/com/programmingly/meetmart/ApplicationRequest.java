...
public class ApplicationRequest extends Application {
    ...
    public static final String TAG = ApplicationRequest.class.getSimpleName();
    private static ApplicationRequest instance;
     ...
     * */
    public static synchronized ApplicationRequest getInstance(Context context) {
        if (instance == null) {
            instance = new ApplicationRequest(context);
        }
        return instance;
